 ...
 */
@Keep
public abstract class BaseActivityWhiteTitle<VDB extends ViewDataBinding> extends AppCompatActivity implements IViewNoModel,IProgressDialogAction {
    protected  String TAG;
    private Dialog dialog;
    public Context mContext;
    public BaseActivityWhiteTitle baseActivity;
