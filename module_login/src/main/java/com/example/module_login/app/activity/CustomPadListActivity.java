...
//        if(pop==null){
        ...
        View view = LayoutInflater.from(this).inflate(
                R.layout.popupwindow_pad_shaixuan, null);
       ...
       LinearLayout ll_bg=view.findViewById(R.id.ll_bg);
        ...
        pop = new PopupWindow(view,
                topView.getWidth(), ViewGroup.LayoutParams.WRAP_CONTENT, true);
        pop.setBackgroundDrawable(new BitmapDrawable());
        ll_bg.setAnimation(AnimationUtils.loadAnimation(view.getContext(),
